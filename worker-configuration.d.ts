/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: feb9a2ae356760bf05297b1f4636fa12)
// Runtime types generated with workerd@1.20250712.0 2025-07-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH0_AUDIENCE: "mold-inventory-api";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH0_AUDIENCE" | "AUTH0_DOMAIN">> {}
}
